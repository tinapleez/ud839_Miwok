...
public class PhrasesActivity extends AppCompatActivity {
     ...
     * playing the audio file. Create global variable - one instance
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Array list of English phrases and Miwok translation
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    // Create MediaPlayer object and start activity using this new Word object
                    mMediaPlayer = MediaPlayer.create(PhrasesActivity.this, word.getSoundResourceId());
                    mMediaPlayer.start();
                    // Setup a listener on the media player, so that we can stop and release the
                    // media player once the sound has finished playing using the global variable
                    // declared above
